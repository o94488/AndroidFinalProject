...
public class NewFeedAsyncSearchResult extends AppCompatActivity {
    ...
    private ListView newsList; //news feed list
    private String positionUrl; //position

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_news_feed_listview);

        Button returnToMainButton = findViewById(R.id.returnToMain); //return button
        newsList = findViewById(R.id.newsList); //new feed list
        ...
        newsList.setOnItemClickListener((parent, view, position, id) -> {
            Intent nextPage = new Intent(NewFeedAsyncSearchResult.this, NewsFeedPage.class);
